Big Data: Proyecto despliegue
    ...
    1- Los scripts de los 7 ejercicios se encuentran en el directorio /stocks/scripts/,
       en el mismo directorio se encuentra el fichero de entrada "ibexunido.csv"

    2- Instrucciones para lanzar los ejercicios:
